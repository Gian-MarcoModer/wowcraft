...
/**
 * Pack vindicator with built-in leash/evade behavior.
 */
public class PackVindicator extends Vindicator implements IPackMob {

    private final PackMobBehavior packBehavior;

    public PackVindicator(EntityType<? extends Vindicator> entityType, Level level) {
