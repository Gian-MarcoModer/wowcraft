...
/**
 * Pack witch with built-in leash/evade behavior.
 */
public class PackWitch extends Witch implements IPackMob {

    private final PackMobBehavior packBehavior;

    public PackWitch(EntityType<? extends Witch> entityType, Level level) {
