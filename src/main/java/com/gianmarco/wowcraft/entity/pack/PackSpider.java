...
/**
 * Pack spider with built-in leash/evade behavior.
 */
public class PackSpider extends Spider implements IPackMob {

    private final PackMobBehavior packBehavior;

    public PackSpider(EntityType<? extends Spider> entityType, Level level) {
