...
/**
 * Base class for all pack mobs with built-in leash/evade behavior.
 */
public abstract class PackMob extends PathfinderMob implements IPackMob {

    protected final PackMobBehavior packBehavior;

    protected PackMob(EntityType<? extends PathfinderMob> entityType, Level level) {
    ...
    // IPackMob implementation - delegate to behavior component
    @Override
