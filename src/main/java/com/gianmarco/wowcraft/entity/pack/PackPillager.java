...
/**
 * Pack pillager with built-in leash/evade behavior.
 */
public class PackPillager extends Pillager implements IPackMob {

    private final PackMobBehavior packBehavior;

    public PackPillager(EntityType<? extends Pillager> entityType, Level level) {
