...
/**
 * Pack zombievillager with built-in leash/evade behavior.
 */
public class PackZombieVillager extends ZombieVillager implements IPackMob {

    private final PackMobBehavior packBehavior;

    public PackZombieVillager(EntityType<? extends ZombieVillager> entityType, Level level) {
