...
/**
 * Pack skeleton with built-in leash/evade behavior.
 */
public class PackSkeleton extends Skeleton implements IPackMob {

    private final PackMobBehavior packBehavior;

    public PackSkeleton(EntityType<? extends Skeleton> entityType, Level level) {
