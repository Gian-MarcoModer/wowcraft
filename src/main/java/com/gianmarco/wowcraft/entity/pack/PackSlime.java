...
/**
 * Pack slime with built-in leash/evade behavior.
 */
public class PackSlime extends Slime implements IPackMob {

    private final PackMobBehavior packBehavior;

    public PackSlime(EntityType<? extends Slime> entityType, Level level) {
