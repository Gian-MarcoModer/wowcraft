...
/**
 * Pack husk with built-in leash/evade behavior.
 */
public class PackHusk extends Husk implements IPackMob {

    private final PackMobBehavior packBehavior;

    public PackHusk(EntityType<? extends Husk> entityType, Level level) {
