...
/**
 * Pack stray with built-in leash/evade behavior.
 */
public class PackStray extends Stray implements IPackMob {

    private final PackMobBehavior packBehavior;

    public PackStray(EntityType<? extends Stray> entityType, Level level) {
