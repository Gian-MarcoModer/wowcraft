...
/**
 * Pack creeper with built-in leash/evade behavior.
 */
public class PackCreeper extends Creeper implements IPackMob {

    private final PackMobBehavior packBehavior;

    public PackCreeper(EntityType<? extends Creeper> entityType, Level level) {
