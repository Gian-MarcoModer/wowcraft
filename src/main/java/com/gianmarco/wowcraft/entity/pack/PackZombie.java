...
/**
 * Pack zombie with built-in leash/evade behavior.
 */
public class PackZombie extends Zombie implements IPackMob {

    private final PackMobBehavior packBehavior;

    public PackZombie(EntityType<? extends Zombie> entityType, Level level) {
